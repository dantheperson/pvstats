...
_register_map = {
  'input': {
    '5001':  {'name': 'nominal_power',     'scale': Decimal(100),   'units': 'W'},
    '5002':  {'name': 'output_type',       'scale': Decimal(1),     'units': ''},
    '5003':  {'name': 'daily_pv_energy',   'scale': Decimal(100),   'units': 'Wh'},
    '5004':  {'name': 'lifetime_pv_energy','scale': Decimal(1000),  'units': 'Wh'},
    '5005':  {'name': 'lifetime_pv_energy_2','scale': Decimal(1000),'units': 'Wh'},
    ...
    '5031':  {'name': 'active_power',      'scale': Decimal(1),     'units': 'W'},
    '5032':  {'name': 'active_power_2',    'scale': Decimal(1),     'units': 'W'},
    '5033':  {'name': 'reactive_power',    'scale': Decimal(1),     'units': 'VAR'},
    '5034':  {'name': 'reactive_power_2',  'scale': Decimal(1),     'units': 'VAR'},
    ...
    '5049':  {'name': 'nominal_reactive_power',               'scale': Decimal(100),   'units': 'VA'},
    ...
    '5083':  {'name': 'meter_power',       'scale': Decimal(1),     'units': 'W'},
    '5084':  {'name': 'meter_power_2',     'scale': Decimal(1),     'units': 'W'},
    '5085':  {'name': 'meter_power_A',     'scale': Decimal(1),     'units': 'W'},
    '5086':  {'name': 'meter_power_A_2',   'scale': Decimal(1),     'units': 'W'},
    '5087':  {'name': 'meter_power_B',     'scale': Decimal(1),     'units': 'W'},
    '5088':  {'name': 'meter_power_B_2',   'scale': Decimal(1),     'units': 'W'},
    '5089':  {'name': 'meter_power_C',     'scale': Decimal(1),     'units': 'W'},
    '5090':  {'name': 'meter_power_C_2',   'scale': Decimal(1),     'units': 'W'},
    '5091':  {'name': 'load_power',        'scale': Decimal(1),     'units': 'W'},
    '5092':  {'name': 'load_power_2',      'scale': Decimal(1),     'units': 'W'},
    '5093':  {'name': 'daily_export_energy',                  'scale': Decimal(100), 'units': 'Wh'},
    '5094':  {'name': 'daily_export_energy_2',                'scale': Decimal(100), 'units': 'Wh'},
    '5095':  {'name': 'lifetime_export_energy',               'scale': Decimal(100), 'units': 'Wh'},
    '5096':  {'name': 'lifetime_export_energy_2',             'scale': Decimal(100), 'units': 'Wh'},
    '5097':  {'name': 'daily_import_energy',                  'scale': Decimal(100), 'units': 'Wh'},
    '5098':  {'name': 'daily_import_energy_2',                'scale': Decimal(100), 'units': 'Wh'},
    '5099':  {'name': 'lifetime_import_energy',               'scale': Decimal(100), 'units': 'Wh'},
    '5100':  {'name': 'lifetime_import_energy_2',             'scale': Decimal(100), 'units': 'Wh'},
    '5101':  {'name': 'daily_direct_consumption_energy',      'scale': Decimal(100), 'units': 'Wh'},
    '5102':  {'name': 'daily_direct_consumption_energy_2',    'scale': Decimal(100), 'units': 'Wh'},
    '5103':  {'name': 'lifetime_direct_consumption_energy',   'scale': Decimal(100), 'units': 'Wh'},
    '5104':  {'name': 'lifetime_direct_consumption_energy_2', 'scale': Decimal(100), 'units': 'Wh'},
    ...
    '5146':  {'name': 'negative_voltage_to_ground',           'scale': Decimal('0.1'), 'units': 'V'},
    '5147':  {'name': 'bus_voltage',       'scale': Decimal('0.1'), 'units': 'V'},   
    '5148':  {'name': 'grid_frequency_2',    'scale': Decimal('0.1'), 'units': 'Hz'},       
  },
  'holding': {
