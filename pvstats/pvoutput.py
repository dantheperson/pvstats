...
class PVOutputClient():
    ...
    def get_status(self, date=None, time=None):
        ...
        return {
            'date': rsp[0],
            'time': rsp[1],
            'energy_generation': rsp[2],
            'power_generation': rsp[3],
            'energy_consumption': rsp[4],
            'power_consumption': rsp[5],
            'normalised_output': rsp[6],
            'temperature': rsp[7],
            'voltage': rsp[8]
        }
